...
# from tensorflow.python.keras.engine.base_layer import Node,_collect_previous_mask, _collect_input_shape

# from tensorflow.python.keras.engine.base_layer import _collect_previous_mask, _collect_input_shape
...
# from keras import Node,_collect_previous_mask, _collect_input_shape
...
print('Setting keras bakend to tensorflow')
if True:
